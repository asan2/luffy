...
public class RedisClient {
     ...
     * @return
     */
    public Boolean  setNx(String key,Object value,long timeoutSeconds){
     ...
     * @return
     */
    public List multiGet(String key, Collection keys) {
